...
This vault uses the **default** profile.

Industry-agnostic. Only the epistemic and entity node types are active.

## Activated profile-conditional node types

_(none — this profile activates no additional node types in v1.)_
...
This profile does not append the controlled-document-boundary footer.
