...
_[Adopters: 2–4 bullets on what landed in this reporting window. v0.4.0 scaffold has no date filter; full implementation in v1.x will window by `verified_at`.]_

## Key facts (metric snapshots)

- [fact-current-team-size-2026-q2] **Fact: Team Size — 2026 Q2** — Vitalisens team size at the end of 2026 Q2: 8 full-time (3 engineering, 2 clinical, 1 regulatory, 1 commercial, 1 founder). _(verified 2026-05-21)_
- [fact-pad-attach-rate-2026-q1] **Fact: Pad Attach Rate at Day 1 — 2026 Q1 Cohort** — Q1 2026 trial cohort day-1 pad attach rate: 89% (12 of 14 patients with continuous data through hour 24). _(verified 2026-05-21)_
- [fact-pad-attach-rate-2026-q2] **Fact: Pad Attach Rate at Day 1 — 2026 Q2 Cohort (interim)** — Q2 2026 interim cohort day-1 pad attach rate: 91% (10 of 11 patients enrolled to date); reflects updated application coaching. _(verified 2026-05-21)_
- [fact-stripe-fee-2-9-percent-plus-30c] **Fact: Stripe US Card Processing Fee** — Stripe's standard US card processing fee is 2.9% of the transaction amount plus a fixed $0.30 per successful charge. Domestic only. _(verified 2026-05-21)_
...
_[Adopters: 2–4 bullets on next steps. Reference decisions or questions above.]_
...
_company-brain v0.3.0 · status-report scaffold generated 2026-05-25 from vault at `/Volumes/Casima/claudeCode/CompanyWiki/company-brain/examples/meddev-fictional`._
